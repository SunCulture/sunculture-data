...
def main():
    st.set_page_config(page_title="Location Visualizer", page_icon="🌍", layout="wide")
    ...
    st.markdown('<h1 class="main-header">🌍 Location Visualization Dashboard</h1>', unsafe_allow_html=True)
    ...
    with col1:
        ...
        center_on_selection = st.checkbox("Center map on filtered data", value=True)
    ...
    with col2:
        st.header("Location Visualization")
